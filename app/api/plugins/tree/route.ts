...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    // 转换字段名
    if (data.birthYear !== undefined) { data.birth_year = data.birthYear ? Number(data.birthYear) : null; delete data.birthYear; }
    if (data.deathYear !== undefined) { data.death_year = data.deathYear ? Number(data.deathYear) : null; delete data.deathYear; }
    if (data.parentIds !== undefined) { data.parent_ids = data.parentIds || null; delete data.parentIds; }
    if (data.spouseId !== undefined) { data.spouse_id = data.spouseId ? Number(data.spouseId) : null; delete data.spouseId; }
    if (data.generation !== undefined) { data.generation = Number(data.generation); }
