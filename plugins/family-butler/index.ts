...
export function isTodayHoliday(): {isHoliday: boolean; name: string} {
  ...
  const holidays: Record<string, string> = {
    ...
    '12-25': '聖誕節',
    '12-31': '跨年夜',
    // 華人重要節日（固定公曆日期的以近似日期標記，農曆節日需每年更新）
    // 以下為 2026 年農曆節日對應的公曆日期：
    '02-17': '除夕',    // 2026 農曆除夕
    '02-18': '春節',    // 2026 農曆春節（初二）
    '02-19': '春節',    // 2026 農曆春節（初三）
    '03-05': '元宵節',  // 2026 農曆正月十五
    '04-02': '清明節',  // 2026 清明節
    '05-31': '端午節',  // 2026 農曆五月初五
    '08-27': '七夕情人節', // 2026 農曆七月初七
    '09-18': '中秋節',  // 2026 農曆八月十五
    '10-29': '重陽節',  // 2026 農曆九月初九
  };
